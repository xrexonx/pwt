...
*/
export class ExmgPaperDatatableElement extends mixinBehaviors(
  [Templatizer],
  PolymerElement
) {
  static get template() {
    return html`
      <style>
        :host {
          ...
          color: var(--exmg-paper-datatable-text-color, rgba(0, 0, 0, 0.87));
...
window.customElements.define(
  ExmgPaperDatatableElement.is,
  ExmgPaperDatatableElement
);
