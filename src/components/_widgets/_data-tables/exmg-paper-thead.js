    ...
    return html`
        <style>
          :host {
            ...
            user-select: none;
            color: var(--exm-thead-color, rgba(0,0,0,.64));
          ...
          .th[sorted] {
            color: var(--exmg-datatable-thead-text-color-sorted, rgba(0,0,0, .78));
          }

          .th[sortable]:hover{
            cursor: pointer;
            color: var(--exmg-datatable-thead-text-color-hover, rgba(0,0,0, .87));
          }
