...
export class ExmgPaperTbodyElement extends mixinBehaviors(
  [Templatizer],
  PolymerElement
) {
  static get template() {
  ...
  _selectionHandler(e) {
    ...
    const activeEl = dom(this.domHost ? this.domHost.root : document)
      .activeElement;
  ...
  _ensureTemplatized() {
    ...
    if (!this.ctor) {
      ...
      if (this._userTemplate) {
        ...
        console.warn(
          'exm-tbody requires a template to be provided in light-dom'
        );
      }
    }
  }
